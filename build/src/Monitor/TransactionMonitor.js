...
var MonitorFrame_1 = require("./MonitorFrame");
var generateURL_1 = require("../outPut/generateURL");
var outputToken_1 = require("../outPut/outputToken");
var getTokenName_1 = require("../Metadata/getTokenName");
var TransactionMonitor = /** @class */ (function (_super) {
    ...
    TransactionMonitor.prototype.onLogsCallback = function (_a) {
    ...
    TransactionMonitor.prototype.fetchRaydiumAccounts = function (txId) {
        return __awaiter(this, void 0, void 0, function () {
            var tx, poolKeysAll, tokenAName, tokenBName, liquidity, msg, error_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        _a.tokenAName = _b.sent();
                        return [4 /*yield*/, tokenBName];
                    case 4:
                        msg = (_a.tokenBName = _b.sent(),
                            _a.liquidity = liquidity,
                            _a);
